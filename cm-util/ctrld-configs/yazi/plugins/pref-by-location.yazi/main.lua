      ...
      if show_hidden_pref ~= nil then
        ...
        local last_hovered_folder = get_state(
          STATE_KEY.last_hovered_folder
            .. tostring(
              (type(cx.active.id) == "number" or type(cx.active.id) == "string") and cx.active.id or cx.active.id.value
            )
        )
        ...
        set_state(
            ...
            ),
          {
            ...
            preview_hovered_folder = cx.active.preview.folder and cx.active.preview.folder.hovered and tostring(
              cx.active.preview.folder.hovered.url
            ),
          }
        )
      end
