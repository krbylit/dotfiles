...
local function setup(_, options)
  ...
  function Status:name()
    ...
    local style = self:style()
    return ui.Line({
      ui.Span(current_separator_style.separator_close .. " "):fg(config.secondary_color or th.which.separator_style.fg),
  ...
  function Status:percent()
    ...
    local style = self:style()
    return ui.Line({
      ui.Span(" " .. current_separator_style.separator_open):fg(config.secondary_color or th.which.separator_style.fg),
      ui.Span(percent):fg(config.color or style.main.bg):bg(config.secondary_color or th.which.separator_style.fg),
