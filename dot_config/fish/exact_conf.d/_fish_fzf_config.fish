...
# Search execution history with Ctrl-e and processes with Ctrl-p
...
function load_fzf_bindings --on-event fish_prompt
    ...
    functions --erase load_fzf_bindings # Only run once
end
...
set -gx _ZO_EXCLUDE_DIRS "$HOME/**/node_modules:$HOME/**/node_modules/**:$HOME/**/.git:$HOME/**/.git/**:$HOME/**/dist:$HOME/**/dist/**:$HOME/**/build:$HOME/**/build/**:$HOME/**/target:$HOME/**/target/**:$HOME/**/.venv:$HOME/**/.venv/**:$HOME/**/__pycache__:$HOME/**/__pycache__/**:$HOME/**/.pytest_cache:$HOME/**/.cargo/registry:$HOME/**/.npm:$HOME/**/.yarn:$HOME/**/coverage:$HOME/**/.next:$HOME/**/.turbo:$HOME/**/tmp:$HOME/**/temp:$HOME/**/.cache"
