return {
    ...
    opts = {
        ...
        winblend = 50, --- integer starting transparency of beacon window :h winblend
        ...
        highlight = { bg = "red", ctermbg = 15 }, -- vim.api.keyset.highlight table passed to vim.api.nvim_set_hl
    },
}
